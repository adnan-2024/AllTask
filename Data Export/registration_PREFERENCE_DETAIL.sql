...
CREATE TABLE `PREFERENCE_DETAIL` (
  ...
  `PREFERED_LOCATION` varchar(45) NOT NULL,
  `NOTICE_PERIOD` varchar(45) NOT NULL,
  `EXPECTED_CTC` decimal(10,0) DEFAULT NULL,
...
INSERT INTO `PREFERENCE_DETAIL` VALUES (1,'Ahmedabad','6',400000,600000,'Development');
