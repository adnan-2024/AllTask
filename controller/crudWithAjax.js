...
const saveEducationDetails=(req,res)=>{
try {
...
const saveWorkExperience=(req,res)=>{
    try{
...
const  saveLanguageDetails=(req,res)=>{
    try{
...
const savePreferncesDetails=(req,res)=>{
    try{
        let id=req.query.userid;
...
const saveReferencesDetails=(req,res)=>{
    try{
        let id=req.query.userid;
...
const saveTechnologyDeatils=(req,res)=>{
    try{
        let technologies=[];
